/**
 * Firebase web client for customer Phone Auth (login/signup OTP SMS sent by Firebase).
 * Named secondary app instance so it does not collide with other Firebase apps in the bundle.
 */
